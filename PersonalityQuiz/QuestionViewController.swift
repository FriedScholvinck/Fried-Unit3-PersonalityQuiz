...
//  PersonalityQuiz
//
//  Created by Fried on 14/11/2018.
...
class QuestionViewController: UIViewController {
    ...
    // create outlet for the switches of question 2
    @IBOutlet weak var multiSwitch1: UISwitch!
    @IBOutlet weak var multiSwitch2: UISwitch!
    @IBOutlet weak var multiSwitch3: UISwitch!
    @IBOutlet weak var multiSwitch4: UISwitch!
    
    // create outlet for question 3
    ...
    // initialize empty collection of player's answers
    ...
    var questions: [Question] = [
        ...
        type: .multiple, answers: [Answer(text: "Swimming", type: .turtle), Answer(text: "Sleeping", type: .cat), Answer(text: "Cuddling", type: .rabbit), Answer(text: "Eating", type: .dog)]),
